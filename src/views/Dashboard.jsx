      ...
      >
        <Card className="bg-gradient-to-br from-indigo-900/60 to-slate-900/80 border-indigo-500/30 relative overflow-hidden group">
          ...
          <div className="flex items-start justify-between relative z-10">
            ...
            <div className="p-3 bg-indigo-500/20 rounded-xl border border-indigo-500/20">
              <Icons.Timer className="w-6 h-6 text-indigo-400" />
            </div>
          </div>
        </Card>
        <Card className="bg-gradient-to-br from-teal-900/60 to-slate-900/80 border-teal-500/30 relative overflow-hidden group">
          ...
          <div className="flex items-start justify-between relative z-10">
            ...
            <div className="p-3 bg-teal-500/20 rounded-xl border border-teal-500/20">
              <Icons.Checklist className="w-6 h-6 text-teal-400" />
            </div>
          </div>
        </Card>
        <Card className="bg-gradient-to-br from-rose-900/60 to-slate-900/80 border-rose-500/30 sm:col-span-2 md:col-span-1 relative overflow-hidden group">
          ...
          <div className="flex items-start justify-between relative z-10">
            ...
            <div className="p-3 bg-rose-500/20 rounded-xl border border-rose-500/20">
              <Icons.Sparkles className="w-6 h-6 text-rose-400" />
            </div>
          </div>
        </Card>
      </motion.div>
          ...
          <Card className="h-full">
            <div className="flex items-center justify-between mb-6">
              ...
              <select 
                ...
                className="bg-slate-800 border border-slate-700 text-sm rounded-lg px-3 py-1.5 focus:outline-none focus:border-primary text-slate-300 cursor-pointer outline-none"
              >
